...
for company in companies:
    ...
    api_endpoint = f"companies({company_id})/salesOrders?$expand=salesOrderLines"
    ...
    for data in raw_data:
        raw2_data=data["salesOrderLines"]
        for orderline in raw2_data:
            saleorderline={
                ...
                'id':orderline['id'],
                'invoiceDiscountAllocation':orderline['invoiceDiscountAllocation'],
                'invoiceQuantity':orderline['invoiceQuantity'],
                'invoicedQuantity':orderline['invoicedQuantity'],
                ...
                'shipmentDate':orderline['shipmentDate'],
